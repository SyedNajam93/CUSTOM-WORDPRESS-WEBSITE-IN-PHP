...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Bootstrap Portfolio Build | Blog</title>
          ...
          <div class="row">
            ...
            <aside class="sidebar col-md-3 col-md-offset-1 col-md-push-8">
              ...
              <div class="widget recent-projects">
                ...
                <ul class="row">
                  <li class="col-md-4">
                    <a href="#">
                      <img src="http://placekitten.com/601/300" class="img-responsive">
                    </a>
                  </li>
                  <li class="col-md-4">
                    <a href="#">
            ...
            <div class="posts col-md-8 col-md-pull-4">
              ...
              <div class="row">
                ...
                <div class="post col-md-6">
                  <a href="#" class="post-thumbnail">
                    <img src="http://placekitten.com/609/300" class="img-responsive">
                  </a>
                  <article class="post-excerpt">
                    <header>
                      <a href="#"><h3>Lorem Ipsum</h3></a>
                ...
                <div class="post col-md-6">
                  <a href="#" class="post-thumbnail">
                    <img src="http://placekitten.com/608/300" class="img-responsive">
                  </a>
                  <article class="post-excerpt">
                    <header>
                      <a href="#"><h3>Lorem Ipsum</h3></a>
                ...
                <div class="post col-md-6">
                  <a href="#" class="post-thumbnail">
                    <img src="http://placekitten.com/607/300" class="img-responsive">
                  </a>
                  <article class="post-excerpt">
                    <header>
                      <a href="#"><h3>Lorem Ipsum</h3></a>
